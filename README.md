...
Продажа требует `Idempotency-Key`, фиксирует цену и сумму и атомарно списывает готовый продукт. Финансовая сводка использует продажи как доход, выплаты как расходы на труд, приход материалов с закупочной ценой как материальные расходы и отдельный журнал ручных операций.
...
Обновление от 17.09.2026: [финансирование, приход, ремонт, номерной выпуск, группы и миграция](docs/BUSINESS_WORKFLOWS.md).
